...
flag 采用 volatile 修饰主要是为了内存可见性，更多内容可以查看[这里](http://shangshangqian.top/2018/03/09/volatile/)。
...
CountDownLatch 也是基于 AQS(AbstractQueuedSynchronizer) 实现的，更多实现参考 [ReentrantLock 实现原理](http://shangshangqian.top/2018/01/25/ReentrantLock/)
